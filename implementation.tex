...
In Python, in \ifuncname{modform_restriction_info} in the file \ifilename{algo.py}, we get an instance of that C++ class and call the function \ifuncname{calcMatrix}.
