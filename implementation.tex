...
The extended Euclidean algorithm (\ifuncname{xgcd}) is the standard algorithm to calculate these numbers. It works over all Euclidean rings.
...
The main work is done in the \ifuncname{divmod} function.
