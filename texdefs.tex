...
\crefname{prelim}{preliminaries}{preliminaries}
...
% http://math.stackexchange.com/questions/401168/notation-for-invariation
...
% This is all about the code. The 'i'-prefix stands for "implementation".
...
% http://sunsite.informatik.rwth-aachen.de/ftp/pub/mirror/ctan/macros/latex/contrib/listings/listings.pdf
...
\newcommand{\isymbname}[1]{\lstinline[style=inline-funcname]{#1}}
...
\newcommand{\ifilename}[1]{\href{https://github.com/albertz/diplom-thesis-math/tree/master/src/#1}{\protect\path{#1}}}
