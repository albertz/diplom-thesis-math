...
For $Z \in \M_n(\C)$, we call $\Re(Z) = \frac{1}{2} (Z + \overline{Z}^{T}) \in \M_n(\C)$ the \defword{real} part and $\Im(Z) = \frac{1}{2i} (Z - \overline{Z}^{T})  \in \M_n(\C)$ the \defword{imaginary} part of $Z$ and we have $Z = \Re(Z) + i \Im(Z)$.
