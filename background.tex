...
We have $\Gamma$ as a subgroup of $\Sp_1(\Z) = \SL_2(\Z)$. A \defword{Elliptic modular form} with weight $k \in \Z$ over $\Gamma$ is a holomorphic function
...
More general cusps: $\Gamma \backslash \SL_2(\Q) \div \Gamma_{\infty, \Q}$, where $\Gamma_{\infty, \Q}$ is the upper triangular matrix in $\GL_2(\Z)$.
