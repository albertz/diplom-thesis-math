...
A matrix $Y \in \M_n(\R)$ is greater $0$ iff $\forall x \in \R^n - \Set{0} \colon Y[x] := x^T Y x > 0$. We cal these the \defword{positive definitive matrices}, defined by $\PM_n = \Set{X \in \M_n}{X > 0}$.
