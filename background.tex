...
A \defword{Hermitian Modular form} of degree $n\in\N$ and weight $k\in \Z$ for some $\Gamma \subseteq \Sp_n(\curlO)$, $\curlO \subseteq \Q(\sqrt{D})$ and $D \in -\N$  is a holomorphic function
\[ f \colon \HalfPlane_n \rightarrow \C \]
with
