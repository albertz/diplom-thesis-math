...
We define
\[ \Gamma_0(l) := \Set{\SimpleMatrix{A}{B}{C}{D} \in \Sp_1(\Z)}{C \equiv 0 \pmod{l}} \subseteq \Sp_1(\Z) \]
...
$\ESpace{k}{\Gamma}$ denotes the vector space of such Elliptic modular forms with weight $k \in \N$.
