...
with $R \subseteq \C$, $\overline{R} \subseteq R$ % wegen Adjunktion. siehe Martin 2013-01-14
...
A matrix $Z \in \M_n(\C)$ is \defword{hermitian} if and only if $\overline{Z}^T = Z$.
...
% $\Sp_n(\curlO)$ is the Hermitian modular group.
