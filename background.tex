...
A matrix $Y \in \M_n(\C)$ is greater $0$ iff $\forall x \in \C^n - \Set{0} \colon Y[x] := \overline{x}^{\tr} Y x \in \R^+$. Such symmetric matrices are called the \defword{positive definitive matrices}, defined by $\PM_n(R) = \Set{X \in \M^T_n(R)}{X > 0}$. For $A,X \in \M_n(\C)$, we define $A[X] := \overline{X}^{\tr} A X$. For $Z \in \M_n(\C)$, we call $\Re(Z) = \frac{1}{2} (Z + \overline{Z}^{\tr}) \in \M_n(\R)$ the real part and $\Im(Z) = \frac{1}{2i} (Z - \overline{Z}^{\tr})  \in \M_n(\R)$ the imaginary part of $Z$ and we have $Z = \Re(Z) + i \Im(Z)$.
