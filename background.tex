...
\[ \Orth_n(R) = \Set{X \in \GL_n(R)}{X^T 1_n X = 1_n} \subseteq \SL_n(R) . \] %Poor
...
\defword{Elliptic modular forms} are Siegel modular forms of degree $n=1$ with weight $k \in \N$ over $\Gamma_0(l)$ for some $l \in \N$.
