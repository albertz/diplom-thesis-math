...
// Translated to C++ by Albert Zeyer (2013).
//
...
struct hermitian_form_with_character_evaluation {
	...
	hermitian_form_with_character_evaluation(M2T_Odual _m = M2T_Odual(), reduce_character_evalutation _char = reduce_character_evalutation())
