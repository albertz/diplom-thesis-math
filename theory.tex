...
\begin{align*}
c_{4,1} &= c_{\gamma_3,1} \cdot a_{3,1} + d_{\gamma_3,1} \cdot \underbrace{c_{3,1}}_{=0} , \\
...
\end{align*}
Set $c_{\gamma_3,4} := b_{\gamma_3,4} := 0$ and $a_{\gamma_3,4} := d_{\gamma_3,4} := 1$. Thus $\SmallMatrix{a_{\gamma_3,1}}{b_{\gamma_3,1}}{c_{\gamma_3,1}}{d_{\gamma_3,1}} = 1_2 \in \Sp_1(\curlO)$. Then we have $c_{4,3} = 0$ and $c_{4,4} = 0$.
