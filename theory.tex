...
In our algorithm we just want to look at $\invar{\Q^\F}{\GL_2(\curlO)}$ which are all the Fourier expansions which satisfy this invariation.
For $T_1, T_2 \in \F$, define the equivalence relation
...
\end{align*}
%
We use this set to identify a base of the finite dimension vector space $\invar{\Q^\F}{\GL_2(\curlO)}$.
\qed
\end{remark}
