...
Let $\mathcal{M}_i$ be a sub vector space of Fourier expansions $a \colon \F \rightarrow \Q$.
...
For example\footnote{This example was calculated with the code at \cite{MyCode}.},
\begin{align*}
