...
We also have $c S^{-1} \in \M_2(\curlO)$, thus we have $M'  \in \Gamma^H = \Sp_2(\curlO)$.
% M' muss ganzzahlig sein, weil:
%> Weil wir im Endeffekt Modulformen zu vollen Gruppe berechnen wollen. Das
%> heißt, f ist darunter invariant, aber nicht unter Transformationen, die
%> gebrochene Einträge haben.
...
\end{align*}
Thus, $f$ is an Elliptic modular form of weight $2k$.
\endproof
\end{lemma}
