...
Let $\tau \in \HalfPlane_1$. Then we have $S \tau \in \HalfPlane_2$. Let $\SmallMatrix{a}{b}{c}{d} \in \SL_2(\Z)$. We have
\begin{align*}
...
=\quad & J_2
\end{align*}
because we have $S = \overline{S}^T$ and $ad  - bc = 1$. Thus, we have
\[ M' := \SimpleMatrix{a 1_2}{b S}{c S^{-1}}{d 1_2} \in \Gamma^H . \]
