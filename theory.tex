...
where
\[ a[S] := \Z \rightarrow \Q, \tau \mapsto a(S \tau), \]
The elements $a$ are the Fourier expansions and $a(T) \in \Q$ for $T \in \F$ are the Fourier coefficients.
This is for a function $f[S] \colon \HalfPlane_1 \rightarrow \C$.
