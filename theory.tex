...
\[ (a[S]|_{2k} M) (p) = \overline{\det(\tilde{S})}^k \cdot \sum_{T \in \Lambda, \tr\left(T \tilde{S} S \overline{\tilde{S}}^T\right) = p} a(T) \cdot e^{2 \pi i \tr\left(T \tilde{T} \overline{\tilde{S}}^T\right)} \]
